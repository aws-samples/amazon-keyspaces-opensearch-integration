...
class OpsServerlessStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, pipeline_role_arn, **kwargs) -> None:
    ...
    cfn_collection = aws_opss.CfnCollection(self, "OpssCollection",
      name=collection_name,
      description="Collection to be used for search analysis using OpenSearch Serverless",
...
#          f"arn:aws:iam::{cdk.Aws.ACCOUNT_ID}:role/admin"
        ],
